# Основы докера. Домашнее задание
программирования на Python (ISA)

### первое домашние задание в папке Hello_world


### второе домашние задание в папке client, worker




### Откройте склонированный репозиторий в PyCharm.**
https://github.com/GeeN33/docker.git
